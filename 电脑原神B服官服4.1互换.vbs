...
a=msgbox("路径错误或者PCGameSDK.dll文件缺失"&chr(10)&"请检查j脚本所在位置和文件是否缺失"&chr(10)&"请前往这里下载所需文件"&chr(10)&"https://yjrqz.lanzoui.com/b01oi27oh 密码:8za8"&chr(10)&"移动到原神此路径/YuanShen_Data/Plugins/",vbCritical + vbYesNo,"错误")
